...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        grouped_df = filtered_df.groupby(['Launch Site', 'class']).size().reset_index(name='class_count')
        fig = px.pie(grouped_df, values='class_count', 
        names='class', 
...
def get_scatter(entered_site, slide):
    low, high = slide[0], slide[1]
